...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
function sendToRDStation(room) {                                                                                       // 1
	if (!RocketChat.settings.get('Livechat_RDStation_Token')) {                                                           // 2
		return room;                                                                                                         // 3
	}                                                                                                                     // 4
                                                                                                                       //
	var livechatData = RocketChat.Livechat.getLivechatRoomGuestInfo(room);                                                // 6
                                                                                                                       //
	if (!livechatData.visitor.email) {                                                                                    // 8
		return room;                                                                                                         // 9
	}                                                                                                                     // 10
                                                                                                                       //
	var options = {                                                                                                       // 12
		...
		data: {                                                                                                              // 16
			token_rdstation: RocketChat.settings.get('Livechat_RDStation_Token'),                                               // 17
			identificador: 'rocketchat-livechat',                                                                               // 18
			client_id: livechatData.visitor._id,                                                                                // 19
			email: livechatData.visitor.email                                                                                   // 20
		}                                                                                                                    // 16
	};                                                                                                                    // 12
	options.data.nome = livechatData.visitor.name || livechatData.visitor.username;                                       // 24
                                                                                                                       //
	if (livechatData.visitor.phone) {                                                                                     // 26
		options.data.telefone = livechatData.visitor.phone;                                                                  // 27
	}                                                                                                                     // 28
                                                                                                                       //
	if (livechatData.tags) {                                                                                              // 30
		options.data.tags = livechatData.tags;                                                                               // 31
	}                                                                                                                     // 32
                                                                                                                       //
	Object.keys(livechatData.customFields || {}).forEach(function (field) {                                               // 34
		options.data[field] = livechatData.customFields[field];                                                              // 35
	});                                                                                                                   // 36
	Object.keys(livechatData.visitor.customFields || {}).forEach(function (field) {                                       // 38
		options.data[field] = livechatData.visitor.customFields[field];                                                      // 39
	});                                                                                                                   // 40
                                                                                                                       //
	try {                                                                                                                 // 42
		HTTP.call('POST', 'https://www.rdstation.com.br/api/1.3/conversions', options);                                      // 43
	} catch (e) {                                                                                                         // 44
		console.error('Error sending lead to RD Station ->', e);                                                             // 45
	}                                                                                                                     // 46
                                                                                                                       //
	return room;                                                                                                          // 48
}                                                                                                                      // 49
...
Meteor.startup(function () {                                                                                           // 1
	...
	RocketChat.settings.add('Livechat_title', 'Helpdesk Chat', {                                                          // 6
		type: 'string',                                                                                                      // 6
		group: 'Livechat',                                                                                                   // 6
		"public": true                                                                                                       // 6
	});                                                                                                                   // 6
	...
	RocketChat.settings.add('Livechat_RDStation_Token', '', {                                                             // 239
		type: 'string',                                                                                                      // 240
		group: 'Livechat',                                                                                                   // 241
		"public": false,                                                                                                     // 242
		section: 'RD Station',                                                                                               // 243
		i18nLabel: 'RDStation_Token'                                                                                         // 244
	});                                                                                                                   // 239
});                                                                                                                    // 246
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
