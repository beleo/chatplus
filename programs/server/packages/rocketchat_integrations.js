...
function executeIntegrationRest() {                                                                                    // 157
	...
	logger.incoming.debug('@bodyParams:', this.bodyParams);                                                               // 160
                                                                                                                       //
	if (this.integration.enabled !== true) {                                                                              // 162
		return {                                                                                                             // 163
			statusCode: 503,                                                                                                    // 164
			body: 'Service Unavailable'                                                                                         // 165
		};                                                                                                                   // 163
	}                                                                                                                     // 167
                                                                                                                       //
	var defaultValues = {                                                                                                 // 169
		channel: this.integration.channel,                                                                                   // 170
		alias: this.integration.alias,                                                                                       // 171
		avatar: this.integration.avatar,                                                                                     // 172
		emoji: this.integration.emoji                                                                                        // 173
	};                                                                                                                    // 169
                                                                                                                       //
	if (this.integration.scriptEnabled === true && this.integration.scriptCompiled && this.integration.scriptCompiled.trim() !== '') {
		var script = void 0;                                                                                                 // 177
                                                                                                                       //
		try {                                                                                                                // 178
			script = getIntegrationScript(this.integration);                                                                    // 179
		} catch (e) {                                                                                                        // 180
			logger.incoming.warn(e);                                                                                            // 181
			return RocketChat.API.v1.failure(e.message);                                                                        // 182
		}                                                                                                                    // 183
                                                                                                                       //
		var request = {                                                                                                      // 185
			url: {                                                                                                              // 186
				hash: this.request._parsedUrl.hash,                                                                                // 187
				search: this.request._parsedUrl.search,                                                                            // 188
				query: this.queryParams,                                                                                           // 189
				pathname: this.request._parsedUrl.pathname,                                                                        // 190
				path: this.request._parsedUrl.path                                                                                 // 191
			},                                                                                                                  // 186
			url_raw: this.request.url,                                                                                          // 193
			url_params: this.urlParams,                                                                                         // 194
			content: this.bodyParams,                                                                                           // 195
			content_raw: this.request._readableState && this.request._readableState.buffer && this.request._readableState.buffer.toString(),
			headers: this.request.headers,                                                                                      // 197
			user: {                                                                                                             // 198
				_id: this.user._id,                                                                                                // 199
				name: this.user.name,                                                                                              // 200
				username: this.user.username                                                                                       // 201
			}                                                                                                                   // 198
		};                                                                                                                   // 185
                                                                                                                       //
		try {                                                                                                                // 205
			var _buildSandbox2 = buildSandbox(compiledScripts[this.integration._id].store),                                     // 205
			    sandbox = _buildSandbox2.sandbox;                                                                               // 205
                                                                                                                       //
			sandbox.script = script;                                                                                            // 207
			sandbox.request = request;                                                                                          // 208
			var result = vm.runInNewContext('script.process_incoming_request({ request: request })', sandbox, {                 // 210
				timeout: 3000                                                                                                      // 211
			});                                                                                                                 // 210
                                                                                                                       //
			if (!result) {                                                                                                      // 214
				logger.incoming.debug('[Process Incoming Request result of Trigger', this.integration.name, ':] No data');         // 215
				return RocketChat.API.v1.success();                                                                                // 216
			} else if (result && result.error) {                                                                                // 217
				return RocketChat.API.v1.failure(result.error);                                                                    // 218
			}                                                                                                                   // 219
                                                                                                                       //
			this.bodyParams = result && result.content;                                                                         // 221
			this.scriptResponse = result.response;                                                                              // 222
                                                                                                                       //
			if (result.user) {                                                                                                  // 223
				this.user = result.user;                                                                                           // 224
			}                                                                                                                   // 225
                                                                                                                       //
			logger.incoming.debug('[Process Incoming Request result of Trigger', this.integration.name, ':]');                  // 227
			logger.incoming.debug('result', this.bodyParams);                                                                   // 228
		} catch (_ref3) {                                                                                                    // 229
			var stack = _ref3.stack;                                                                                            // 229
			logger.incoming.error('[Error running Script in Trigger', this.integration.name, ':]');                             // 230
			logger.incoming.error(this.integration.scriptCompiled.replace(/^/gm, '  '));                                        // 231
			logger.incoming.error('[Stack:]');                                                                                  // 232
			logger.incoming.error(stack.replace(/^/gm, '  '));                                                                  // 233
			return RocketChat.API.v1.failure('error-running-script');                                                           // 234
		}                                                                                                                    // 235
	} // TODO: Turn this into an option on the integrations - no body means a success                                     // 236
	// TODO: Temporary fix for https://github.com/RocketChat/Rocket.Chat/issues/7770 until the above is implemented       // 239
                                                                                                                       //
                                                                                                                       //
	if (!this.bodyParams) {                                                                                               // 240
		// return RocketChat.API.v1.failure('body-empty');                                                                   // 241
		return RocketChat.API.v1.success();                                                                                  // 242
	}                                                                                                                     // 243
                                                                                                                       //
	this.bodyParams.bot = {                                                                                               // 245
		i: this.integration._id                                                                                              // 245
	};                                                                                                                    // 245
                                                                                                                       //
	try {                                                                                                                 // 247
		var message = processWebhookMessage(this.bodyParams, this.user, defaultValues);                                      // 248
                                                                                                                       //
		if (_.isEmpty(message)) {                                                                                            // 249
			return RocketChat.API.v1.failure('unknown-error');                                                                  // 250
		}                                                                                                                    // 251
                                                                                                                       //
		if (this.scriptResponse) {                                                                                           // 253
			logger.incoming.debug('response', this.scriptResponse);                                                             // 254
		}                                                                                                                    // 255
                                                                                                                       //
		return RocketChat.API.v1.success(this.scriptResponse);                                                               // 257
	} catch (_ref4) {                                                                                                     // 258
		var error = _ref4.error;                                                                                             // 258
		return RocketChat.API.v1.failure(error);                                                                             // 259
	}                                                                                                                     // 260
}                                                                                                                      // 261
                                                                                                                       //
function addIntegrationRest() {                                                                                        // 263
	return createIntegration(this.bodyParams, this.user);                                                                 // 264
}                                                                                                                      // 265
                                                                                                                       //
function removeIntegrationRest() {                                                                                     // 267
	return removeIntegration(this.bodyParams, this.user);                                                                 // 268
}                                                                                                                      // 269
                                                                                                                       //
function integrationSampleRest() {                                                                                     // 271
	logger.incoming.info('Sample Integration');                                                                           // 272
	return {                                                                                                              // 273
		statusCode: 200,                                                                                                     // 274
		body: [{                                                                                                             // 275
			token: Random.id(24),                                                                                               // 277
			channel_id: Random.id(),                                                                                            // 278
			channel_name: 'general',                                                                                            // 279
			timestamp: new Date(),                                                                                              // 280
			user_id: Random.id(),                                                                                               // 281
			user_name: 'rocket.cat',                                                                                            // 282
			text: 'Sample text 1',                                                                                              // 283
			trigger_word: 'Sample'                                                                                              // 284
		}, {                                                                                                                 // 276
			token: Random.id(24),                                                                                               // 286
			channel_id: Random.id(),                                                                                            // 287
			channel_name: 'general',                                                                                            // 288
			timestamp: new Date(),                                                                                              // 289
			user_id: Random.id(),                                                                                               // 290
			user_name: 'rocket.cat',                                                                                            // 291
			text: 'Sample text 2',                                                                                              // 292
			trigger_word: 'Sample'                                                                                              // 293
		}, {                                                                                                                 // 285
			token: Random.id(24),                                                                                               // 295
			channel_id: Random.id(),                                                                                            // 296
			channel_name: 'general',                                                                                            // 297
			timestamp: new Date(),                                                                                              // 298
			user_id: Random.id(),                                                                                               // 299
			user_name: 'rocket.cat',                                                                                            // 300
			text: 'Sample text 3',                                                                                              // 301
			trigger_word: 'Sample'                                                                                              // 302
		}]                                                                                                                   // 294
	};                                                                                                                    // 273
}                                                                                                                      // 306
                                                                                                                       //
function integrationInfoRest() {                                                                                       // 308
	logger.incoming.info('Info integration');                                                                             // 309
	return {                                                                                                              // 310
		statusCode: 200,                                                                                                     // 311
		body: {                                                                                                              // 312
			success: true                                                                                                       // 313
                                                                                                                       ...
                                                                                                                       //
Api.addRoute(':integrationId/:userId/:token', {                                                                        // 318
	authRequired: true                                                                                                    // 318
}, {                                                                                                                   // 318
	post: executeIntegrationRest,                                                                                         // 319
	get: executeIntegrationRest                                                                                           // 320
});                                                                                                                    // 318
Api.addRoute(':integrationId/:token', {                                                                                // 323
	authRequired: true                                                                                                    // 323
}, {                                                                                                                   // 323
	post: executeIntegrationRest,                                                                                         // 324
	get: executeIntegrationRest                                                                                           // 325
});                                                                                                                    // 323
Api.addRoute('sample/:integrationId/:userId/:token', {                                                                 // 328
	authRequired: true                                                                                                    // 328
}, {                                                                                                                   // 328
	get: integrationSampleRest                                                                                            // 329
});                                                                                                                    // 328
Api.addRoute('sample/:integrationId/:token', {                                                                         // 332
	authRequired: true                                                                                                    // 332
}, {                                                                                                                   // 332
	get: integrationSampleRest                                                                                            // 333
});                                                                                                                    // 332
Api.addRoute('info/:integrationId/:userId/:token', {                                                                   // 336
	authRequired: true                                                                                                    // 336
}, {                                                                                                                   // 336
	get: integrationInfoRest                                                                                              // 337
});                                                                                                                    // 336
Api.addRoute('info/:integrationId/:token', {                                                                           // 340
	authRequired: true                                                                                                    // 340
}, {                                                                                                                   // 340
	get: integrationInfoRest                                                                                              // 341
});                                                                                                                    // 340
Api.addRoute('add/:integrationId/:userId/:token', {                                                                    // 344
	authRequired: true                                                                                                    // 344
}, {                                                                                                                   // 344
	post: addIntegrationRest                                                                                              // 345
});                                                                                                                    // 344
Api.addRoute('add/:integrationId/:token', {                                                                            // 348
	authRequired: true                                                                                                    // 348
}, {                                                                                                                   // 348
	post: addIntegrationRest                                                                                              // 349
});                                                                                                                    // 348
Api.addRoute('remove/:integrationId/:userId/:token', {                                                                 // 352
	authRequired: true                                                                                                    // 352
}, {                                                                                                                   // 352
	post: removeIntegrationRest                                                                                           // 353
});                                                                                                                    // 352
Api.addRoute('remove/:integrationId/:token', {                                                                         // 356
	authRequired: true                                                                                                    // 356
}, {                                                                                                                   // 356
	post: removeIntegrationRest                                                                                           // 357
});                                                                                                                    // 356
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
this.processWebhookMessage = function (messageObj, user) {                                                             // 1
	...
	var mustBeJoined = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;                         // 1
	var sentData = [];                                                                                                    // 2
		...
		switch (channelType) {                                                                                               // 11
			...
			default:                                                                                                            // 18
				...
				throw new Meteor.Error('invalid-channel');                                                                         // 34
                                                                                                                       ...
                                                                                                                       //
		if (mustBeJoined && !room.usernames.includes(user.username)) {                                                       // 37
			// throw new Meteor.Error('invalid-room', 'Invalid room provided to send a message to, must be joined.');           // 38
			throw new Meteor.Error('invalid-channel'); // Throwing the generic one so people can't "brute force" find rooms     // 39
		}                                                                                                                    // 40
                                                                                                                       //
		if (messageObj.attachments && !_.isArray(messageObj.attachments)) {                                                  // 42
			console.log('Attachments should be Array, ignoring value'.red, messageObj.attachments);                             // 43
			messageObj.attachments = undefined;                                                                                 // 44
		}                                                                                                                    // 45
                                                                                                                       //
		var message = {                                                                                                      // 47
			alias: messageObj.username || messageObj.alias || defaultValues.alias,                                              // 48
			msg: _.trim(messageObj.text || messageObj.msg || ''),                                                               // 49
			attachments: messageObj.attachments,                                                                                // 50
			parseUrls: messageObj.parseUrls !== undefined ? messageObj.parseUrls : !messageObj.attachments,                     // 51
			bot: messageObj.bot,                                                                                                // 52
			groupable: messageObj.groupable !== undefined ? messageObj.groupable : false                                        // 53
		};                                                                                                                   // 47
                                                                                                                       //
		if (!_.isEmpty(messageObj.icon_url) || !_.isEmpty(messageObj.avatar)) {                                              // 56
			message.avatar = messageObj.icon_url || messageObj.avatar;                                                          // 57
		} else if (!_.isEmpty(messageObj.icon_emoji) || !_.isEmpty(messageObj.emoji)) {                                      // 58
			message.emoji = messageObj.icon_emoji || messageObj.emoji;                                                          // 59
		} else if (!_.isEmpty(defaultValues.avatar)) {                                                                       // 60
			message.avatar = defaultValues.avatar;                                                                              // 61
		} else if (!_.isEmpty(defaultValues.emoji)) {                                                                        // 62
			message.emoji = defaultValues.emoji;                                                                                // 63
		}                                                                                                                    // 64
                                                                                                                       //
		if (_.isArray(message.attachments)) {                                                                                // 66
			for (var i = 0; i < message.attachments.length; i++) {                                                              // 67
				var attachment = message.attachments[i];                                                                           // 68
                                                                                                                       //
				if (attachment.msg) {                                                                                              // 69
					attachment.text = _.trim(attachment.msg);                                                                         // 70
					delete attachment.msg;                                                                                            // 71
				}                                                                                                                  // 72
			}                                                                                                                   // 73
		}                                                                                                                    // 74
                                                                                                                       //
		var messageReturn = RocketChat.sendMessage(user, message, room);                                                     // 76
		sentData.push({                                                                                                      // 77
			channel: channel,                                                                                                   // 77
			message: messageReturn                                                                                              // 77
		});                                                                                                                  // 77
	}                                                                                                                     // 78
                                                                                                                       //
	return sentData;                                                                                                      // 80
