...
/* eslint no-multi-spaces: 0 */Meteor.startup(function () {                                                 // 1
	...
	{                                                                                                          // 24
		...
		_id: 'view-outside-room',                                                                                 // 67
		roles: ['admin', 'owner', 'moderator', 'user']                                                            // 67
	}];                                                                                                        // 67
                                                                                                            //
	for (var _iterator = permissions, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
		var _ref;                                                                                                 // 70
                                                                                                            //
		if (_isArray) {                                                                                           // 70
			if (_i >= _iterator.length) break;                                                                       // 70
			_ref = _iterator[_i++];                                                                                  // 70
		} else {                                                                                                  // 70
			_i = _iterator.next();                                                                                   // 70
			if (_i.done) break;                                                                                      // 70
			_ref = _i.value;                                                                                         // 70
		}                                                                                                         // 70
                                                                                                            //
		var permission = _ref;                                                                                    // 70
                                                                                                            //
		if (!RocketChat.models.Permissions.findOneById(permission._id)) {                                         // 71
			RocketChat.models.Permissions.upsert(permission._id, {                                                   // 72
				$set: permission                                                                                        // 72
			});                                                                                                      // 72
		}                                                                                                         // 73
	}                                                                                                          // 74
	...
	var defaultRoles = [{                                                                                      // 76
		name: 'admin',                                                                                            // 77
		scope: 'Users',                                                                                           // 77
		description: 'Admin'                                                                                      // 77
	}, {                                                                                                       // 77
		name: 'moderator',                                                                                        // 78
		scope: 'Subscriptions',                                                                                   // 78
		description: 'Moderator'                                                                                  // 78
	}, {                                                                                                       // 78
		name: 'leader',                                                                                           // 79
		scope: 'Subscriptions',                                                                                   // 79
		description: 'Leader'                                                                                     // 79
	}, {                                                                                                       // 79
		name: 'owner',                                                                                            // 80
		scope: 'Subscriptions',                                                                                   // 80
	...
	for (var _iterator2 = defaultRoles, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
		var _ref2;                                                                                                // 87
                                                                                                            //
		if (_isArray2) {                                                                                          // 87
			if (_i2 >= _iterator2.length) break;                                                                     // 87
			_ref2 = _iterator2[_i2++];                                                                               // 87
		} else {                                                                                                  // 87
			_i2 = _iterator2.next();                                                                                 // 87
			if (_i2.done) break;                                                                                     // 87
			_ref2 = _i2.value;                                                                                       // 87
		}                                                                                                         // 87
                                                                                                            //
		var role = _ref2;                                                                                         // 87
		RocketChat.models.Roles.upsert({                                                                          // 88
			_id: role.name                                                                                           // 88
		}, {                                                                                                      // 88
			$setOnInsert: {                                                                                          // 88
				scope: role.scope,                                                                                      // 88
				description: role.description || '',                                                                    // 88
				"protected": true                                                                                       // 88
			}                                                                                                        // 88
		});                                                                                                       // 88
	}                                                                                                          // 89
